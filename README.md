...
### Open Source 📦
* **[shinyfilters](https://github.com/joshwlivingston/shinyfilters)**: Create shiny inputs for vectors and data.frames. [![CRAN status](https://www.r-pkg.org/badges/version/shinyfilters)](https://CRAN.R-project.org/package=shinyfilters)
